"""editctrl inpainting inference on Wan2.1-VACE-1.3B.

Default behavior: download the local LoRA and global DiT delta from
Hugging Face (thebluser/Wan2.1-VACE-1.3B-editctrl). Pass --local_ckpt
...
HF_REPO = "thebluser/Wan2.1-VACE-1.3B-editctrl"
