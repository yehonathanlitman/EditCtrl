...
def parse_args():
    ...
    p.add_argument("--local_ckpt", default="./models/train/Wan2.1-VACE-1.3B_editctrl_local/step-10000.safetensors")
    p.add_argument("--global_ckpt", default="./models/train/Wan2.1-VACE-1.3B_editctrl_global/step-10000.safetensors")
    ...
    p.add_argument("--output_dir", default="outputs/editctrl_1.3B_test")
    return p.parse_args()
