...
accelerate launch --mixed_precision bf16 --num_processes 2 examples/wanvideo/model_training/train.py \
  ...
  --output_path "./models/train/Wan2.2-VACE-Fun-A14B_editctrl_local_high_noise" \
...
accelerate launch --mixed_precision bf16 --num_processes 2 examples/wanvideo/model_training/train.py \
  ...
  --save_steps 500 \
  --max_train_steps 10000 \
  --preset_lora_path "./models/train/Wan2.2-VACE-Fun-A14B_editctrl_local_high_noise/step-10000.safetensors" \
  --preset_lora_model "vace" \
  --remove_prefix_in_ckpt "pipe.dit." \
  --output_path "./models/train/Wan2.2-VACE-Fun-A14B_editctrl_global_high_noise" \
  --extra_inputs "vace_video,vace_video_mask" \
  --enable_inpaint_local \
